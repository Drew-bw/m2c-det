...
class BoxAMDetectorWrapper(nn.Module):
    ...
    def set_input_data(self,
        ...
        if self.is_need_loss:
            ...
            #     img=self.image,
            #     img_id=0,
            #     gt_bboxes=pred_instances.gt_instances.bboxes,
            #     gt_bboxes_labels=pred_instances.gt_instances.labels)
    ...
    def __call__(self, *args, **kwargs):
        ...
        if self.is_need_loss:
            ...
            data = self.detector.data_preprocessor(self.input_data, training=False)
            loss = self.detector(
...
class BoxAMDetectorVisualizer:
    ...
    def __call__(self, img, targets, aug_smooth=False, eigen_smooth=False):
        ...
        # ====detr===
        self.cam.model.detector.decoder.training = True
        self.cam.model.detector.training = True
        results = self.cam(img, targets, aug_smooth, eigen_smooth)[0, :]
        self.cam.model.detector.decoder.training = False
        self.cam.model.detector.training = False
        return results
    ...
    def show_am(self,
        ...
        image_with_bounding_boxes = am_image_renormalized
