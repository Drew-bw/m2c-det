...
model = dict(
    ...
    language_model=dict(
        use_cache=True,
        cache_path='../datasets/text_embedding_moblieclip.pt',
        embed_dims=256,
        use_align=False),
    backbone=dict(
        type='HGNetV2',
...
train_pipeline_stage1 = [
    ...
    dict(type='RandomLoadText',
         neg_samples=(num_classes, num_classes),
         max_samples=num_classes,
         shuffle=True,
         padding=True),
    dict(
        type='PackDetInputs',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset_mode=['VG', 'VG', 'OD'],
        data_prefix=[
            dict(img='images/'),
            dict(img='images/'),
            dict(img='images/train/'),
        ],
...
val_evaluator = dict(
    ...
    ann_file='../datasets/coco/lvis/annotations/lvis_v1_minival_inserted_image_name.json')
